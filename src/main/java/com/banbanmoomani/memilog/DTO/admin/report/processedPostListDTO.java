...
public class processedPostListDTO {
    ...
    private Date report_process_datetime;

    public processedPostListDTO() {
    }

    public processedPostListDTO(int post_id, String reported_user_nickName, String post_content, String report_content, int report_count, String rpt_category, Date report_process_datetime) {
    ...
    public Date getReport_process_datetime() {
        return report_process_datetime;
    }
